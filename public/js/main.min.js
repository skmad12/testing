...
$("#show-ans").click(function(){updateAns();$("#answer").toggleClass("hidden");$(this).toggleClass("fa-eye-slash");$(this).toggleClass("fa-eye");});$("#answer-box").keypress(function(e){console.log(e);var key=e.which;if(key==13){validate();}});});